          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            >
              <div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="white" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
