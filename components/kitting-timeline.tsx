...
const STEPS = [
  {
    title: "Sourcing",
    description: "Finding the best promotional products!",
    paths: [
  ...
  {
    title: "Designing",
    description: "Branding your products in the most creative way!",
    paths: [
  ...
  {
    title: "Packaging",
    description: "Adding a wow factor with endless packaging options!",
    paths: [
  ...
  {
    title: "Shipping",
    description: "Drop shipping, LTL Freight, and customized shipping services!",
    paths: [
  ...
  {
    title: "Delighting",
    description: "Sales & Client Services team with you from start to finish!",
    paths: [
